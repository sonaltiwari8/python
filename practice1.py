...
to_find = int(input("enter the roll number"))
start = 0
end = len(students)-1
not_found = True
...
while start <= end:
    mid = (start + end) // 2
    if students[mid]["roll_number"] == to_find:
        print(f"name of the student is {students[mid]["student_name"]}")
        not_found = False
        break
    elif students[mid]["roll_number"] < to_find:
        start = mid + 1
    else:
        end = mid - 1
if not_found:
    print("we cant find the roll number you entered")
...
#             "total_marks": students[i]["maths"]+students[i]["english"]+students[i]["computer"]+students[i]["science"]+students[i]["drawing"]
#         }
...
# i = 1
# while i < len(new_list):
#     if new_list[i]["total_marks"] > topper["total_marks"]:
#         topper = new_list[i]
#     i += 1
...
# new_list = []
# for a in students:
#     if a["roll_number"] % 2 == 1:
#         new_list.append(a)
# i = 0
# while i < len(new_list):
#     print(f"name of the student is {
#         new_list[i]["student_name"]} and roll_number is {new_list[i]["roll_number"]}")
#     i += 1

# for a in new_list:
#     print(f"name of the student is {
#           a["student_name"]} and roll_number is {a["roll_number"]}")


# list = [10, 20, 30, 40, 50, 60, 70, 80, 90, 200]
# to_find = 200
# start = 0
# end = len(list)-1
